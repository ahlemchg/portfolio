...
const displayedSkills = ["Full Stack Developer", "Software Engineer"];
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <motion.div className="flex flex-col justify-center space-y-4" style={{ y: y1 }}>
              <div className="space-y-2">
                ...
                >
                  Full Stack Developer building modern web applications and scalable REST APIs. BSc
                  in Information Systems Engineering at Université d'Alger 1. Certified Full Stack
                  JavaScript.
                </motion.p>
              </div>
              ...
              >
                ...
                <Button variant="outline" size="lg" asChild>
                  <a
                    href="/resume.pdf"
                    download="Chegroune_Ahlem_CV.pdf"
                    target="_blank"
            ...
            >
              <div className="relative aspect-square w-full max-w-md overflow-hidden rounded-full">
                <Image
                  src="/images/profile-chegroune.jpg"
                  alt="Chegroune Ahlem"
                  fill
