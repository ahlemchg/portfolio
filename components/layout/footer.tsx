      ...
      >
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Chegroune Ahlem</h3>
            <p className="max-w-xs text-sm text-muted-foreground">
              Full Stack Developer based in Algiers, Algeria. Building complete web applications from
              intuitive front-ends to robust back-ends.
            </p>
          </div>
        ...
        >
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center text-sm text-muted-foreground">
              ...
              <span>{new Date().getFullYear()} Chegroune Ahlem. All rights reserved.</span>
            </div>
